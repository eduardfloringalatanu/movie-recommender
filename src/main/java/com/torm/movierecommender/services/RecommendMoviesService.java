...
import com.torm.movierecommender.utils.MathUtils;
...
public class RecommendMoviesService {
    ...
    public Flux<String> recommendMovies(RecommendMoviesRequestBody recommendMoviesRequestBody, Jwt jwt) {
        ...
        Set<String> excludedGenres = recommendMoviesRequestBody.excludedGenres();
        boolean hasExcludedGenres = excludedGenres != null && !excludedGenres.isEmpty();

        Short minReleaseYear = recommendMoviesRequestBody.minReleaseYear();
        ...
        List<MovieRecommendationCandidate> movieRecommendationCandidateList = movies.stream()
                ...
                .map(movie -> {
                    ...
                    float cosineSimilarityFactor = centroid == null ? 0.0f : MathUtils.cosineSimilarity(centroid, embeddings);
